...
public class SheetList {
    public List<Sheet> sheetList() {
        ...
        String sheetFile1 = "https:/anoaiapi.appspot.com/o/Midi%2Ff1d4cb7b-9e3b-445e-a3e7-f97fc78e5434_Sao_Sang.mid?alt=media&token=fb758635-1027-43cc-bbff-1a0db24177bb";
        ...
        // Data for second Sheet/firebasestorage.googleapis.com/v0/b/pi
        int songId2 = 2;
        int topSignature2 = 3;
